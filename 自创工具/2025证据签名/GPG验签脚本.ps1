...
# 定义原件和签名文件的路径
$originalPath = [System.IO.Path]::GetFullPath("I:")  # 改为根目录，支持递归搜索
$signaturePath = [System.IO.Path]::GetFullPath("F:\老司机工具\自创工具\2025证据签名\签名文件")
$publicKeyPath = [System.IO.Path]::GetFullPath("G:\keys\gpg\case20190120@outlook.com\王贵平_05pub.asc")

# 已知公钥指纹（如有，直接填写，否则留空）
$knownFingerprint = "15977DCF1A61ECA784CCF3F141FFD57D15150144"
